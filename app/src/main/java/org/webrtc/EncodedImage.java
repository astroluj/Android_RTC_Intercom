...
public class EncodedImage implements RefCounted {
    ...
    @CalledByNative
    private EncodedImage(ByteBuffer buffer, @Nullable Runnable releaseCallback, int encodedWidth, int encodedHeight, long captureTimeNs, EncodedImage.FrameType frameType, int rotation, boolean completeFrame, @Nullable Integer qp) {
        this.buffer = buffer;
